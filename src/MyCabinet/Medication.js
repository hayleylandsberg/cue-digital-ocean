...
export default class Medication extends Component {
    ...
    archive = (medicationId) => {
        fetch(`https://cue-medical-management-app.herokuapp.com/medications/${medicationId}`, {
            method: "PATCH",
            headers: {
    ...
    areMedsTaken = () => {
        fetch(`https://cue-medical-management-app.herokuapp.com/medications?&userId=${this.props.activeUser}&takenMeds=false&archive=false`)
            .then(r => r.json())
            .then(medications => {
